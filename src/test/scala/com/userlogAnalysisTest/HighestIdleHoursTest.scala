...
class HighestIdleHoursTest extends FunSuite with BeforeAndAfter {
  ...
  val userNameWithDateIdle = "deepshukla292@gmail.com:2019-09-21"
  ...
  test("givenDataMustEvaluateIdleTimeAndReturnMustEqualToActual") {
  ...
  test("givenInputForMapperItMustProcessKeyValueAndReducerMustReturnValue") {
    ...
    mapReduceDriver.addOutput(new Text("iamnzm@outlook.com"), new Text("  -  " + 0.0 + " Hours"))
