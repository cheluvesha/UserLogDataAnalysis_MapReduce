...
import com.highestAverageHour.{HighestAverageHourMapper, HighestAverageHourReducer}
...
class HighestAverageHourTest extends FunSuite with BeforeAndAfter {
  ...
  var reducer: HighestAverageHourReducer  = _
  var mapper: HighestAverageHourMapper = _

  def setup(): Unit = {
    mapper = new HighestAverageHourMapper
    mapDriver = new MapDriver[Object, Text, Text, IntWritable]()
    mapDriver.setMapper(mapper)

    reducer = new HighestAverageHourReducer
